...
KNOWN_PYTHON_VERSION_STRINGS = ["2.3", "2.4", "2.6", "2.7", "3.0", "3.1", "3.3", "3.5", "3.6", "3.7", "3.8"]
...
class PartialParserConfig:
    ...
    #: interpreter.
    #:
    #: Currently, only Python 2.3, 2.4, 2.6, 2.7, 3.0, 3.1, 3.3, 3.5, 3.6, 3.7 and 3.8 syntax is supported.
