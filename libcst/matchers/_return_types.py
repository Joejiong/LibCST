...
TYPED_FUNCTION_RETURN_MAPPING: TypingDict[Type[CSTNode], object] = {
    ...
    Py2Backticks: BaseExpression,
    Py2Exec: Union[BaseSmallStatement, RemovalSentinel],
    Py2ExecTarget: Py2ExecTarget,
    Py2Integer: BaseExpression,
    Py2Print: Union[BaseSmallStatement, RemovalSentinel],
    Py2PrintExpr: Union[Py2PrintExpr, RemovalSentinel],
    Py2Raise: Union[BaseSmallStatement, RemovalSentinel],
